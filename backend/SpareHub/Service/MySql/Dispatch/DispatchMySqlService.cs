...
public class DispatchMySqlService(IDispatchRepository dispatchRepository) : IDispatchService
{
    public async Task<DispatchResponse> CreateDispatch(DispatchRequest dispatchRequest, string orderId)
    {
        ...
        {
            throw new RepositoryException("Failed to create dispatch.", ex);
        }
    ...
    public async Task<DispatchResponse> GetDispatchById(string dispatchId)
    {
        ...
        {
            throw new RepositoryException("Failed to fetch dispatch.", e);
        }
    }
    ...
    public async Task<IEnumerable<DispatchResponse>> GetDispatches()
    {
        ...
        {
            throw new RepositoryException("Failed to fetch dispatches.", e);
        }
    }
    ...
    public async Task<DispatchResponse> UpdateDispatch(string dispatchId, DispatchRequest dispatchRequest)
    {
        ...
        {
            throw new RepositoryException("Failed to update dispatch.", ex);
        }
    }
    ...
    public async Task DeleteDispatch(string dispatchId)
    {
        ...
        {
            throw new RepositoryException("Failed to delete dispatch.", e);
        }
    }
}